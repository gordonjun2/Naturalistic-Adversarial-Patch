...
from GANLatentDiscovery.models.ProgGAN.model import Generator as ProgGenerator
from GANLatentDiscovery.models.SNGAN.load import load_model_from_state_dict
