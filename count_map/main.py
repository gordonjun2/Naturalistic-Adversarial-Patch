...
def count(path_ground_truth, path_detection_results, path_images_optional=None):
    output_map = -1
    ...
    # st()
    GT_PATH = os.path.join(os.getcwd(),"../", path_ground_truth)
    DR_PATH = os.path.join(os.getcwd(),"../", path_detection_results)
    # if there are no images then no animation can be shown
    if(path_images_optional ==None):
        IMG_PATH = os.path.join(os.getcwd(), 'input', 'images-optional')
    else:
        IMG_PATH = os.path.join(os.getcwd(),"../", path_images_optional)
    ...
    gt_files = []
    # st()
    for iii, txt_file in enumerate(ground_truth_files_list):
        # print(txt_file)
        # print(iii)
