...
if __name__ == '__main__':
    ...
    patchfile = "saved_patches/patch_500.jpg"
    ...
    for imgfile in os.listdir(imgdir):
        ...
        if imgfile.endswith('.jpg') or imgfile.endswith('.png'):
            ...
            padded_img_original = padded_img
            cleanname = name + ".png"
            #sla dit beeld op
            ...
            adv_batch_t = patch_transformer(adv_patch, lab_fake_batch, img_size, do_rotate=True, rand_loc=False, roi=[75,75])
